              ...
              <div className="flex flex-wrap  g-0">
                ...
                <div className="xl:w-1/2 pr-4 pl-4">
                  ...
                  <div className="flex-auto p-6 md:p-12">
                    <h3 className="mb-5 text-blue-600 fw-bold">
                      Registration Form
                    </h3>
                    <form onSubmit={signupForm.handleSubmit} >
                      ...
                      <div class="mb-3">
                        ...
                        {signupForm.touched.email && (
                          <small class="text-red-600">{signupForm.errors.email}</small>
                        )}
                      </div>
                      <div class="mb-3">
                        ...
                        {signupForm.touched.name && (
                          <small class="text-red-600">{signupForm.errors.name}</small>
                        )}
                      </div>
                      <div class="mb-3">
                        ...
                        {signupForm.touched.password && (
                          <small class="text-red-600">{signupForm.errors.password}</small>
                        )}
                      </div>
                      <div class="mb-3">
                        ...
                        {signupForm.touched.confirmPassword && (
                          <small class="text-red-600">{signupForm.errors.confirmPassword}</small>
                        )}
                      </div>
                      ...
                      <div className="flex justify-end pt-3">
                        <button type="button" className="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-gray-100 text-gray-800 hover:bg-gray-200">
                          Reset all
                        </button>
                        <button type="submit" className="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-blue-600 text-white hover:bg-blue-600 ms-2">
                          Submit form
                        </button>
                      </div>
                    </form>
